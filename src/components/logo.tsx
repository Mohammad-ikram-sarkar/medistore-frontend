...
export const Logo = ({ className, }: { className?: string; uniColor?: boolean }) => {
    return (
        <svg
            ...
            {/* Text Only */}
            <text x="10" y="35" fontFamily="system-ui" fontSize="32" fontWeight="700" fill="currentColor">
                Medicine
            </text>
...
export const LogoIcon = ({ className, uniColor }: { className?: string; uniColor?: boolean }) => {
    return (
        <svg
            ...
            {/* Capsule Shape */}
            <path
                d="M4 10C4 6.13401 7.13401 3 11 3H17C20.866 3 24 6.13401 24 10V14C24 17.866 20.866 21 17 21H11C7.13401 21 4 17.866 4 14V10Z"
                fill={uniColor ? 'currentColor' : 'url(#icon-gradient)'}
            />
            {/* Medical Cross */}
            <rect x="8" y="10" width="3" height="8" fill="white" rx="0.5" />
            <rect x="6" y="12" width="8" height="3" fill="white" rx="0.5" />
            <rect x="16" y="10" width="3" height="8" fill="white" rx="0.5" />
            <rect x="14" y="12" width="8" height="3" fill="white" rx="0.5" />
